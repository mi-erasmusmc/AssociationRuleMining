---
title: "Whole ARM and FP workflow Example 1"
...
tidydata <- Temporalcleandata %>% getNamesFromCovariateId(., covariateDataObject = covariateData_eunomia) # 

#ames(tidydata)
#library(arules)
#armdata <- select(tidydata, c(rowId, covariateLabel)) %>% getARMdata()
#getARMdata(tidydata)
write.table(tidydata, "data/processed/eunomia_MI_trans_seqs.txt", sep=";", row.names = FALSE, col.names = FALSE, quote = FALSE)
TemporalData <- read_baskets("data/processed/eunomia_MI_trans_seqs.txt")
```
