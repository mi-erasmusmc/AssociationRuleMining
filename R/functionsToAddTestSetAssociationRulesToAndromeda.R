#' @export
testSetAssociationRulesToCovariateData <- function(inputFile, 
                                                   objectWithIds,
                                                   transactionsRowId, 
                                                   plpDataTrain){
...
#' @export
testSetAssociationRulesToCovariateDataObject <- function(fileWithFPs, 
                                                          objectWithIds, 
                                                          covariateDataObject, 
                                                          transactionsRowId, 
                                                          plpDataTrain){
  ...
  fpdata <- testSetAssociationRulesToCovariateData(inputFile = fileWithFPs, 
...
#' @export
addTestSetAssociationRulesToAndromeda <- function(plpDataObject, 
                                                    fileWithFPs, 
                                                    plpDataTrain, 
                                                    objectWithIds, 
                                                    transactionsRowId, 
  ...
  covariateData <- testSetAssociationRulesToCovariateDataObject(fileWithFPs = fileWithFPs, 
                                                       objectWithIds = objectWithIds, 
